...
total_cases_per_day_it = np.array([1, 17, 58, 78, 72, 94, 147, 185, 234, 239, 573, 335,
                                   ...
                                   5974, 5217, 4050, 4053, 4782, 4668, 4585])
...
deaths_per_day_it = np.array([0, 0, 0, 0, 4, 4, 0, 5, 4, 8, 12, 11, 27, 28, 41,
                              ...
                              919, 889, 756, 812, 837, 727, 760, 766])
...
def plot_results(Im: np.ndarray, Rm: np.ndarray, Id: np.ndarray, Rd: np.ndarray, total_population: int = N_uk):
    ...
    plt.grid()
    # UK
    plt.xticks([0, 26, 53, 80], ["27/02/2020",
                                 "25/03/2020", "21/04/2020", "18/05/2020"])
    # UK removing the first 8
    # plt.xticks([0, 18, 45, 72], ["05/03/2020", "25/03/2020", "21/04/2020" , "18/05/2020"])
